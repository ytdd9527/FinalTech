...
public abstract class AbstractBasicMachine extends AbstractStandardMachine {
    ...
    protected final MachineRecipe matchRecipe(BlockMenu blockMenu, int offset, int recipeLock) {
        ...
        AdvancedCraftV2 craft = AdvancedCraftV2.craftAsc(blockMenu, this.getInputSlot(), advancedMachineRecipeList, 1, offset);
        if(craft != null) {
