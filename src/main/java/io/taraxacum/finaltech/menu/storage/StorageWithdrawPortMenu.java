...
public class StorageWithdrawPortMenu extends AbstractMachineMenu {
    ...
    public StorageWithdrawPortMenu(@Nonnull String id, @Nonnull String title, AbstractMachine machine) {
