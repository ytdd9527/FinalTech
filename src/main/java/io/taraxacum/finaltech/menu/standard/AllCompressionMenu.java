 ...
 * @author Final_ROOT
 */
public class AllCompressionMenu extends AbstractStandardMachineMenu {
    ...
    public AllCompressionMenu(@Nonnull String id, @Nonnull String title, AbstractMachine abstractMachine) {
