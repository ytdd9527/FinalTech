 ...
 * @author Final_ROOT
 */
public class OrderedDustFactoryMenu extends AbstractStandardMachineMenu {
    ...
    public OrderedDustFactoryMenu(@Nonnull String id, @Nonnull String title, @Nonnull AbstractMachine abstractMachine) {
