...
public class ConstantTableUtil {
    ...
    public static final int ITEM_SPIROCHETE_AMOUNT = ConfigUtil.getOrDefaultConfigSetting(64, "SPIROCHETE", "amount") + (int) (Math.pow(Slimefun.getRegistry().getAllSlimefunItems().size(), 0.5) * 4);
}
