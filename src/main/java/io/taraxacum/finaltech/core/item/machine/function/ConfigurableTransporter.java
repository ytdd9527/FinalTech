...
import io.taraxacum.finaltech.core.menu.accessor.ConfigurableTransporterMenu;
 ...
 * @since 2.2
 */
public class ConfigurableTransporter extends AbstractFunctionMachine implements RecipeItem {
    ...
    protected AbstractMachineMenu setMachineMenu() {
        return new ConfigurableTransporterMenu(this);
    }
