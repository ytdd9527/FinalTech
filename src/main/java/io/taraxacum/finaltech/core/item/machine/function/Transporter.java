...
import io.taraxacum.finaltech.core.menu.accessor.TransporterMenu;
 ...
 * @since 2.2
 */
public class Transporter extends AbstractFunctionMachine implements RecipeItem {
    ...
    protected AbstractMachineMenu setMachineMenu() {
        return new TransporterMenu(this);
    }
