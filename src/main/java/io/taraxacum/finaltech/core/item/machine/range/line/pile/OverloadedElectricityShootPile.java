...
public class OverloadedElectricityShootPile extends AbstractElectricityShootPile {
    ...
    protected RangeFunction doFunction(@Nonnull Summary summary) {
        return location -> {
            ...
            if (locationInfo != null && !this.NOT_ALLOWED_ID.contains(locationInfo.getId()) && locationInfo.getSlimefunItem() instanceof EnergyNetComponent energyNetComponent && !EnergyNetComponentType.NONE.equals(energyNetComponent.getEnergyComponentType()) && energyNetComponent.isChargeable()) {
