...
public class LargeExpandedCapacitor extends AbstractExpandedElectricCapacitor {
    ...
    private final double chargeIncrease = ConfigUtil.getOrDefaultItemSetting(1.3, this, "charge-increase");
    private final double consumeReduce = ConfigUtil.getOrDefaultItemSetting(0.85, this, "consume-reduce");
