 ...
 * @since 2.2
 */
public class ConfigurationPaster extends AbstractMachine implements RecipeItem {
    ...
    protected void tick(@Nonnull Block block, @Nonnull SlimefunItem slimefunItem, @Nonnull Config config) {
        ...
        if(blockData instanceof Directional directional) {
            ...
            if(work) {
                ...
                Runnable runnable = () -> {
                    if(ItemConfigurationUtil.loadConfigFromItem(outputItem, finalTargetLocation)) {
                        ItemConfigurationUtil.extraSaveFunction(BlockStorage.getInventory(finalTargetBlock), itemId);
                    ...
                    blockMenu.pushItem(outputItem, ConfigurationPaster.this.getOutputSlot()[0]);
