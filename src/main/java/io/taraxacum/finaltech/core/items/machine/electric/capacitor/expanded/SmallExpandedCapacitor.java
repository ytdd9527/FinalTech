...
public class SmallExpandedCapacitor extends AbstractExpandedElectricCapacitor {
    ...
    private final int stack = ConfigUtil.getOrDefaultItemSetting(128, this, "stack");
    private final double chargeIncrease = ConfigUtil.getOrDefaultItemSetting(1.05, this, "charge-increase");
    private final double consumeReduce = ConfigUtil.getOrDefaultItemSetting(0.975, this, "consume-reduce");
