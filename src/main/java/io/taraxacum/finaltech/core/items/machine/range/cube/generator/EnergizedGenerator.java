...
public class EnergizedGenerator extends AbstractCubeElectricGenerator {
    private final String electricity = FinalTech.getValueManager().getOrDefault("64", "items", SlimefunUtil.getIdFormatName(EnergizedGenerator.class), "electricity");
    private final int range = FinalTech.getValueManager().getOrDefault(4, "items", SlimefunUtil.getIdFormatName(EnergizedGenerator.class), "range");
