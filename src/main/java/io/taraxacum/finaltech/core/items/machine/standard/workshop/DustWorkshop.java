 ...
 * @since 2.0
 */
public class DustWorkshop extends AbstractWorkshopMachine{
    public DustWorkshop(ItemGroup itemGroup, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe) {
    ...
    public void registerDefaultRecipes() {
        ...
        RandomMachineRecipe randomMachineRecipe = new RandomMachineRecipe(0, new ItemStack[] {new ItemStack(Material.COBBLESTONE)}, List.of(randomOutput1, randomOutput2, randomOutput3, randomOutput4, randomOutput5, randomOutput6, randomOutput7, randomOutput8, randomOutput9));
