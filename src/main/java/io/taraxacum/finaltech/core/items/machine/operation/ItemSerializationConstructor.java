...
public class ItemSerializationConstructor extends AbstractOperationMachine {
    ...
    public void registerDefaultRecipes() {
        ...
        this.registerDescriptiveRecipe(TextUtil.COLOR_PASSIVE + "制造 " + FinalTechItems.SINGULARITY.getDisplayName(),
                "",
                TextUtil.COLOR_NORMAL + "输入任意 " + TextUtil.COLOR_NUMBER + Singularity.DIFFICULTY + "个" + TextUtil.COLOR_NORMAL + " 任意物品的复制卡",
        ...
        this.registerDescriptiveRecipe(TextUtil.COLOR_PASSIVE + "制造 " + FinalTechItems.SPIROCHETE.getDisplayName(),
                "",
                TextUtil.COLOR_NORMAL + "输入任意 " + TextUtil.COLOR_NUMBER + Spirochete.DIFFICULTY + "种" + TextUtil.COLOR_NORMAL + " 不同物品的复制卡",
