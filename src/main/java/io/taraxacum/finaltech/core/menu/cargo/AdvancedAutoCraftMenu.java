...
public class AdvancedAutoCraftMenu extends AbstractMachineMenu {
    ...
    private static final ItemStack PARSE_ICON = new CustomItemStack(Material.OBSERVER, FinalTech.getLanguageString("items", SfItemUtil.getIdFormatName(AdvancedAutoCraft.class), "parse-icon", "name"), FinalTech.getLanguageStringArray("items", SfItemUtil.getIdFormatName(AdvancedAutoCraft.class), "parse-icon", "lore"));
    ...
    private static final ItemStack WIKI_ICON = new CustomItemStack(Material.KNOWLEDGE_BOOK, FinalTech.getLanguageString("items", SfItemUtil.getIdFormatName(AdvancedAutoCraft.class), "wiki-icon", "name"), FinalTech.getLanguageStringArray("items", SfItemUtil.getIdFormatName(AdvancedAutoCraft.class), "wiki-icon", "lore"));

    private static final ItemStack PARSE_FAILED_ICON = new CustomItemStack(Material.RED_STAINED_GLASS_PANE, FinalTech.getLanguageString("items", SfItemUtil.getIdFormatName(AdvancedAutoCraft.class), "parse-failed-icon", "name"), FinalTech.getLanguageStringArray("items", SfItemUtil.getIdFormatName(AdvancedAutoCraft.class), "parse-failed-icon", "lore"));
    private static final ItemStack PARSE_SUCCESS_ICON = new CustomItemStack(Material.GREEN_STAINED_GLASS_PANE, FinalTech.getLanguageString("items", SfItemUtil.getIdFormatName(AdvancedAutoCraft.class), "parse-success-icon", "name"), FinalTech.getLanguageStringArray("items", SfItemUtil.getIdFormatName(AdvancedAutoCraft.class), "parse-success-icon", "lore"));
    private static final ItemStack PARSE_EXTEND_ICON = new CustomItemStack(Material.PURPLE_STAINED_GLASS_PANE, FinalTech.getLanguageString("items", SfItemUtil.getIdFormatName(AdvancedAutoCraft.class), "parse-extend-icon", "name"), FinalTech.getLanguageStringArray("items", SfItemUtil.getIdFormatName(AdvancedAutoCraft.class), "parse-extend-icon", "lore"));
    ...
    private void setParseSuccessMenu(@Nonnull Inventory inventory, @Nonnull Location location, @Nonnull AdvancedMachineRecipe advancedMachineRecipe) {
        ...
        for (i = 0; i < ITEM_INPUT_SLOT.length - 1; i++) {
            if (i < advancedMachineRecipe.getInput().length) {
                ...
                ItemStackUtil.addLoreToLast(icon, FinalTech.getLanguageManager().replaceString(FinalTech.getLanguageString("items", SfItemUtil.getIdFormatName(AdvancedAutoCraft.class), "parse-amount"), String.valueOf(amount)));
        ...
        ItemStackUtil.addLoreToLast(icon, FinalTech.getLanguageManager().replaceString(FinalTech.getLanguageString("items", SfItemUtil.getIdFormatName(AdvancedAutoCraft.class), "parse-amount"), String.valueOf(advancedMachineRecipe.getOutput()[0].getAmount())));
