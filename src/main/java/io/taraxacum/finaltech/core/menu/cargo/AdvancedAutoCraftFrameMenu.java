...
public class AdvancedAutoCraftFrameMenu extends AbstractMachineMenu {
    ...
    private final ItemStack parseSuccessIcon = new CustomItemStack(Material.GREEN_STAINED_GLASS_PANE, FinalTech.getLanguageString("items", SfItemUtil.getIdFormatName(AdvancedAutoCraftFrame.class), "parse-success-icon", "name"), FinalTech.getLanguageStringArray("items", SfItemUtil.getIdFormatName(AdvancedAutoCraftFrame.class), "parse-success-icon", "lore"));
    private final ItemStack parseExtendIcon = new CustomItemStack(Material.PURPLE_STAINED_GLASS_PANE, FinalTech.getLanguageString("items", SfItemUtil.getIdFormatName(AdvancedAutoCraftFrame.class), "parse-extend-icon", "name"), FinalTech.getLanguageStringArray("items", SfItemUtil.getIdFormatName(AdvancedAutoCraftFrame.class), "parse-extend-icon", "lore"));
