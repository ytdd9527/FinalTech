...
public class TransferPipeMenu extends AbstractMachineMenu {
    ...
    public void init() {
        ...
        this.addItem(CARGO_MODE_SLOT, CargoMode.HELPER.getOrErrorIcon(CargoMode.VALUE_STRONG_SYMMETRY));
    }
    ...
    public void newInstance(@Nonnull BlockMenu blockMenu, @Nonnull Block block) {
        ...
        blockMenu.addMenuClickHandler(CARGO_MODE_SLOT, (player, i, itemStack, clickAction) -> {
            String cargoMode = CargoMode.HELPER.nextOrDefaultValue(BlockStorage.getLocationInfo(block.getLocation(), CargoMode.KEY));
            blockMenu.replaceExistingItem(CARGO_MODE_SLOT, CargoMode.HELPER.getOrErrorIcon(cargoMode));
    ...
    public void updateMenu(@Nonnull BlockMenu blockMenu, Block block) {
        ...
        blockMenu.replaceExistingItem(CARGO_MODE_SLOT, CargoMode.HELPER.getOrErrorIcon(BlockStorage.getLocationInfo(block.getLocation(), CargoMode.KEY)));
