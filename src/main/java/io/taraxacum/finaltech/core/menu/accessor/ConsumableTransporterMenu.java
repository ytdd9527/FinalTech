...
import io.taraxacum.finaltech.core.item.machine.function.Transporter;
 ...
 * @since 2.2
 */
public class ConsumableTransporterMenu extends AbstractAccessorMenu {
    ...
    public ConsumableTransporterMenu(@Nonnull AbstractMachine machine) {
        super(machine);
    }
