 ...
 * @since 2.2
 */
public class ExpandedConsumableTransporterMenu extends AbstractClickerMenu {
    ...
    public ExpandedConsumableTransporterMenu(@Nonnull AbstractClickerMachine slimefunItem, int range) {
        super(slimefunItem);
        this.range = range;
    }
