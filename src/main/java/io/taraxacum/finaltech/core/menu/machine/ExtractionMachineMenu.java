...
public class ExtractionMachineMenu extends AbstractMachineMenu {
    private static final int[] BORDER = new int[] {36, 37, 38, 39, 40, 41, 42, 43, 44};
    ...
    public ExtractionMachineMenu(@Nonnull AbstractMachine machine) {
        super(machine);
    }
