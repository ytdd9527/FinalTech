...
public final class BlockSearchMode {
    ...
    public static final BlockStorageIconHelper LINK_INPUT_HELPER = BlockStorageIconHelper.newInstanceOrGet(BlockStorageHelper.ID_CARGO, KEY_INPUT + SUB_KEY_PIPE, new LinkedHashMap<>() {{
            this.put(VALUE_ZERO, ZERO_ICON);
            this.put(VALUE_INHERIT, INHERIT_ICON);
            this.put(VALUE_PENETRATE, PENETRATE_ICON);
    }});
    public static final BlockStorageIconHelper LINK_OUTPUT_HELPER = BlockStorageIconHelper.newInstanceOrGet(BlockStorageHelper.ID_CARGO, KEY_OUTPUT + SUB_KEY_PIPE, new LinkedHashMap<>() {{
            this.put(VALUE_ZERO, ZERO_ICON);
            this.put(VALUE_INHERIT, INHERIT_ICON);
            this.put(VALUE_PENETRATE, PENETRATE_ICON);
    }});
