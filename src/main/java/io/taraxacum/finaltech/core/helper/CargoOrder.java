...
public final class CargoOrder {
    ...
    public static final ItemStack POSITIVE_ICON = new CustomItemStack(Material.CRIMSON_DOOR, "&7传输方向", "&f正向");
    public static final ItemStack REVERSE_ICON = new CustomItemStack(Material.CRIMSON_DOOR, "&7传输方向", "&f逆向");
