...
public class FinalTechRecipeTypes {
    ...
    public static final RecipeType BOX = new RecipeType(new NamespacedKey(FinalTech.getInstance(), FinalTechItemStacks.BOX.getItemId().toLowerCase(Locale.ROOT)), FinalTechItemStacks.BOX);
    ...
    public static final RecipeType CARD_OPERATION_TABLE = new RecipeType(new NamespacedKey(FinalTech.getInstance(), FinalTechItemStacks.CARD_OPERATION_TABLE.getItemId().toLowerCase(Locale.ROOT)), FinalTechItemStacks.CARD_OPERATION_TABLE);
