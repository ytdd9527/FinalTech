...
import io.taraxacum.finaltech.core.item.unusable.module.QuantityModuleEnergized;
import io.taraxacum.finaltech.core.item.unusable.module.QuantityModuleMatrix;
import io.taraxacum.finaltech.core.item.unusable.module.QuantityModuleOverloaded;
...
public final class FinalTechItems {
    ...
    public static final QuantityModuleEnergized QUANTITY_MODULE_ENERGIZED = new QuantityModuleEnergized(FinalTechMenus.MENU_ITEMS, FinalTechItemStacks.QUANTITY_MODULE_ENERGIZED, FinalTechRecipeTypes.MATRIX_CRAFTING_TABLE, FinalTechRecipes.QUANTITY_MODULE_ENERGIZED);
    public static final QuantityModuleOverloaded QUANTITY_MODULE_OVERLOADED = new QuantityModuleOverloaded(FinalTechMenus.MENU_ITEMS, FinalTechItemStacks.QUANTITY_MODULE_OVERLOADED, FinalTechRecipeTypes.MATRIX_CRAFTING_TABLE, FinalTechRecipes.QUANTITY_MODULE_OVERLOADED);
    ...
    public static final RouteViewer ROUTE_VIEWER = new RouteViewer(FinalTechMenus.MENU_ITEMS, FinalTechItemStacks.ROUTE_VIEWER, RecipeType.ENHANCED_CRAFTING_TABLE, FinalTechRecipes.ROUTE_VIEWER);
    ...
    public static final RandomAccessor RANDOM_ACCESSOR = new RandomAccessor(FinalTechMenus.MENU_CARGO_SYSTEM, FinalTechItemStacks.RANDOM_ACCESSOR, FinalTechRecipeTypes.MATRIX_CRAFTING_TABLE, FinalTechRecipes.RANDOM_ACCESSOR);
    ...
    public static final InfinityMachineChargeCard MACHINE_CHARGE_CARD_INFINITY = new InfinityMachineChargeCard(FinalTechMenus.MENU_DISC, FinalTechItemStacks.MACHINE_CHARGE_CARD_INFINITY, FinalTechRecipeTypes.MATRIX_CRAFTING_TABLE, FinalTechRecipes.MACHINE_CHARGE_CARD_INFINITY);
    public static final InfinityMachineAccelerateCard MACHINE_ACCELERATE_CARD_INFINITY = new InfinityMachineAccelerateCard(FinalTechMenus.MENU_DISC, FinalTechItemStacks.MACHINE_ACCELERATE_CARD_INFINITY, FinalTechRecipeTypes.MATRIX_CRAFTING_TABLE, FinalTechRecipes.MACHINE_ACCELERATE_CARD_INFINITY);
    public static final MatrixMachineActivateCard MACHINE_ACTIVATE_CARD_L4 = new MatrixMachineActivateCard(FinalTechMenus.MENU_DISC, FinalTechItemStacks.MACHINE_ACTIVATE_CARD_L4, FinalTechRecipeTypes.MATRIX_CRAFTING_TABLE, FinalTechRecipes.MACHINE_ACTIVATE_CARD_L4);
    ...
    public static final QuantityModuleMatrix QUANTITY_MODULE_MATRIX = new QuantityModuleMatrix(FinalTechMenus.MENU_ITEMS, FinalTechItemStacks.QUANTITY_MODULE_MATRIX, FinalTechRecipeTypes.MATRIX_CRAFTING_TABLE, FinalTechRecipes.QUANTITY_MODULE_MATRIX);
    public static final OperationAcceleratorMatrix OPERATION_ACCELERATOR_MATRIX = new OperationAcceleratorMatrix(FinalTechMenus.MENU_FUNCTIONAL_MACHINE, FinalTechItemStacks.MATRIX_OPERATION_ACCELERATOR, FinalTechRecipeTypes.MATRIX_CRAFTING_TABLE, FinalTechRecipes.OPERATION_ACCELERATOR_INFINITY);
