...
public final class FinalTechItems {
    // items
    public static final SlimefunItemStack WATER_CARD = new SlimefunItemStack("FINALTECH_WATER_CARD", Material.PAPER, TextUtil.colorPseudorandomString("水卡"), StorageCardItem.ITEM_LORE);
    ...
    public static final SlimefunItemStack COPY_CARD = new SlimefunItemStack("FINALTECH_COPY_CARD", Material.PAPER, TextUtil.colorPseudorandomString("复制卡"));
    public static final SlimefunItemStack ANNULAR = new SlimefunItemStack("FINALTECH_ANNULAR", Material.PAPER, TextUtil.colorPseudorandomString("环"));
    ...
    public static final SlimefunItemStack SPIROCHETE = new SlimefunItemStack("FINALTECH_SPIROCHETE", Material.ARMOR_STAND, TextUtil.colorPseudorandomString("螺旋体"));
    ...
    public static final SlimefunItemStack BUG = new SlimefunItemStack("FINALTECH_BUG", Material.STICK, TextUtil.colorPseudorandomString("锟斤拷"));
    ...
    public static final SlimefunItemStack MACHINE_CHARGE_CARD_L1 = new SlimefunItemStack("FINALTECH_MACHINE_CHARGE_CARD_L1", Material.PAPER, TextUtil.colorPseudorandomString("充能卡L1"));
    public static final SlimefunItemStack MACHINE_CHARGE_CARD_L2 = new SlimefunItemStack("FINALTECH_MACHINE_CHARGE_CARD_L2", Material.PAPER, TextUtil.colorPseudorandomString("充能卡L2"));
    public static final SlimefunItemStack MACHINE_CHARGE_CARD_L3 = new SlimefunItemStack("FINALTECH_MACHINE_CHARGE_CARD_L3", Material.PAPER, TextUtil.colorPseudorandomString("充能卡L3"));
    public static final SlimefunItemStack MACHINE_ACCELERATE_CARD_L1 = new SlimefunItemStack("FINALTECH_MACHINE_ACCELERATE_CARD_L1", Material.PAPER, TextUtil.colorPseudorandomString("过载卡L1"));
    public static final SlimefunItemStack MACHINE_ACCELERATE_CARD_L2 = new SlimefunItemStack("FINALTECH_MACHINE_ACCELERATE_CARD_L2", Material.PAPER, TextUtil.colorPseudorandomString("过载卡L2"));
    public static final SlimefunItemStack MACHINE_ACCELERATE_CARD_L3 = new SlimefunItemStack("FINALTECH_MACHINE_ACCELERATE_CARD_L3", Material.PAPER, TextUtil.colorPseudorandomString("过载卡L3"));
    public static final SlimefunItemStack MACHINE_ACTIVATE_CARD_L1 = new SlimefunItemStack("FINALTECH_MACHINE_ACTIVATE_CARD_L1", Material.PAPER, TextUtil.colorPseudorandomString("带电超频卡L1"));
    public static final SlimefunItemStack MACHINE_ACTIVATE_CARD_L2 = new SlimefunItemStack("FINALTECH_MACHINE_ACTIVATE_CARD_L2", Material.PAPER, TextUtil.colorPseudorandomString("带电超频卡L2"));
    public static final SlimefunItemStack MACHINE_ACTIVATE_CARD_L3 = new SlimefunItemStack("FINALTECH_MACHINE_ACTIVATE_CARD_L3", Material.PAPER, TextUtil.colorPseudorandomString("带电超频卡L3"));
    ...
    public static final SlimefunItemStack RANDOM_INPUT_STORAGE_UNIT = new SlimefunItemStack("FINALTECH_RANDOM_INPUT_STORAGE_UNIT", Material.GLASS, TextUtil.colorPseudorandomString("随机存存入单元"));
    ...
    public static final SlimefunItemStack TRANSFER_PIPE = new SlimefunItemStack("FINALTECH_CARGO_TRANSFER_PIPE", Material.END_ROD, TextUtil.colorPseudorandomString("对点传输器"), "§8即放即用");
    ...
    public static final SlimefunItemStack STORAGE_ITEM_WHITE = new SlimefunItemStack("FINALTECH_STORAGE_ITEM_WHITE", Material.WHITE_CONCRETE_POWDER, TextUtil.colorPseudorandomString("存储卡-白"),
            StorageCardItem.ITEM_LORE,
            "§7未存储物品");
    public static final SlimefunItemStack STORAGE_ITEM_ORANGE = new SlimefunItemStack("FINALTECH_STORAGE_ITEM_ORANGE", Material.ORANGE_CONCRETE_POWDER, TextUtil.colorPseudorandomString("存储卡-橙"),
            StorageCardItem.ITEM_LORE,
            "§7未存储物品");
    public static final SlimefunItemStack STORAGE_ITEM_MAGENTA = new SlimefunItemStack("FINALTECH_STORAGE_ITEM_MAGENTA", Material.MAGENTA_CONCRETE_POWDER, TextUtil.colorPseudorandomString("存储卡-品红"),
            StorageCardItem.ITEM_LORE,
            "§7未存储物品");
    public static final SlimefunItemStack STORAGE_ITEM_LIGHT_BLUE = new SlimefunItemStack("FINALTECH_STORAGE_ITEM_LIGHT_BLUE", Material.LIGHT_BLUE_CONCRETE_POWDER, TextUtil.colorPseudorandomString("存储卡-淡蓝"),
            StorageCardItem.ITEM_LORE,
            "§7未存储物品");
    public static final SlimefunItemStack STORAGE_ITEM_YELLOW = new SlimefunItemStack("FINALTECH_STORAGE_ITEM_YELLOW", Material.YELLOW_CONCRETE_POWDER, TextUtil.colorPseudorandomString("存储卡-黄"),
            StorageCardItem.ITEM_LORE,
            "§7未存储物品");
    public static final SlimefunItemStack STORAGE_ITEM_LIME = new SlimefunItemStack("FINALTECH_STORAGE_ITEM_LIME", Material.LIME_CONCRETE_POWDER, TextUtil.colorPseudorandomString("存储卡-黄绿"),
            StorageCardItem.ITEM_LORE,
            "§7未存储物品");
    public static final SlimefunItemStack STORAGE_ITEM_PINK = new SlimefunItemStack("FINALTECH_STORAGE_ITEM_PINK", Material.PINK_CONCRETE_POWDER, TextUtil.colorPseudorandomString("存储卡-粉红"),
            StorageCardItem.ITEM_LORE,
            "§7未存储物品");
    public static final SlimefunItemStack STORAGE_ITEM_GRAY = new SlimefunItemStack("FINALTECH_STORAGE_ITEM_GRAY", Material.GRAY_CONCRETE_POWDER, TextUtil.colorPseudorandomString("存储卡-灰"),
            StorageCardItem.ITEM_LORE,
            "§7未存储物品");
    public static final SlimefunItemStack STORAGE_ITEM_LIGHT_GRAY = new SlimefunItemStack("FINALTECH_STORAGE_ITEM_LIGHT_GRAY", Material.LIGHT_GRAY_CONCRETE_POWDER, TextUtil.colorPseudorandomString("存储卡-淡灰"),
            StorageCardItem.ITEM_LORE,
            "§7未存储物品");
    public static final SlimefunItemStack STORAGE_ITEM_CYAN = new SlimefunItemStack("FINALTECH_STORAGE_ITEM_CYAN", Material.CYAN_CONCRETE_POWDER, TextUtil.colorPseudorandomString("存储卡-青"),
            StorageCardItem.ITEM_LORE,
            "§7未存储物品");
    public static final SlimefunItemStack STORAGE_ITEM_PURPLE = new SlimefunItemStack("FINALTECH_STORAGE_ITEM_PURPLE", Material.PURPLE_CONCRETE_POWDER, TextUtil.colorPseudorandomString("存储卡-紫"),
            StorageCardItem.ITEM_LORE,
            "§7未存储物品");
    public static final SlimefunItemStack STORAGE_ITEM_BLUE = new SlimefunItemStack("FINALTECH_STORAGE_ITEM_BLUE", Material.BLUE_CONCRETE_POWDER, TextUtil.colorPseudorandomString("存储卡-蓝"),
            StorageCardItem.ITEM_LORE,
            "§7未存储物品");
    public static final SlimefunItemStack STORAGE_ITEM_BROWN = new SlimefunItemStack("FINALTECH_STORAGE_ITEM_BROWN", Material.BROWN_CONCRETE_POWDER, TextUtil.colorPseudorandomString("存储卡-棕"),
            StorageCardItem.ITEM_LORE,
            "§7未存储物品");
    public static final SlimefunItemStack STORAGE_ITEM_GREEN = new SlimefunItemStack("FINALTECH_STORAGE_ITEM_GREEN", Material.GREEN_CONCRETE_POWDER, TextUtil.colorPseudorandomString("存储卡-绿"),
            StorageCardItem.ITEM_LORE,
            "§7未存储物品");
    public static final SlimefunItemStack STORAGE_ITEM_RED = new SlimefunItemStack("FINALTECH_STORAGE_ITEM_RED", Material.RED_CONCRETE_POWDER, TextUtil.colorPseudorandomString("存储卡-红"),
            StorageCardItem.ITEM_LORE,
            "§7未存储物品");
    public static final SlimefunItemStack STORAGE_ITEM_BLACK = new SlimefunItemStack("FINALTECH_STORAGE_ITEM_BLACK", Material.BLACK_CONCRETE_POWDER, TextUtil.colorPseudorandomString("存储卡-黑"),
            StorageCardItem.ITEM_LORE,
            "§7未存储物品");
    ...
    public static final SlimefunItemStack ALL_COMPRESSION = new SlimefunItemStack("FINALTECH_ALL_COMPRESSION", Material.AMETHYST_BLOCK, TextUtil.colorPseudorandomString("序列化构造器"));
    public static final SlimefunItemStack ALL_FACTORY = new SlimefunItemStack("FINALTECH_ALL_FACTORY", Material.BUDDING_AMETHYST, TextUtil.colorPseudorandomString("反序列化解析器"));
    ...
    public static final SlimefunItemStack BASIC_LIQUID_FACTORY = new SlimefunItemStack("FINALTECH_BASIC_LIQUID_FACTORY", Material.CAULDRON, TextUtil.colorPseudorandomString("基础流体工厂"));
    ...
    public static final SlimefunItemStack MANUAL_ORE_WASHER = new SlimefunItemStack("FINALTECH_MANUAL_ORE_WASHER", Material.CRAFTING_TABLE, TextUtil.colorPseudorandomString("快捷洗矿机"));
    public static final SlimefunItemStack MANUAL_COMPOSTER = new SlimefunItemStack("FINALTECH_MANUAL_COMPOSTER", Material.CRAFTING_TABLE, TextUtil.colorPseudorandomString("快捷搅拌机"));
    public static final SlimefunItemStack MANUAL_GOLD_PAN = new SlimefunItemStack("FINALTECH_MANUAL_GOLD_PAN", Material.CRAFTING_TABLE, TextUtil.colorPseudorandomString("快捷淘金机"));
    public static final SlimefunItemStack MANUAL_CRUCIBLE = new SlimefunItemStack("FINALTECH_CRUCIBLE", Material.CRAFTING_TABLE, TextUtil.colorPseudorandomString("快捷坩埚"));
    ...
    // advanced machines
    public static final SlimefunItemStack ADVANCED_COMPOSTER = new SlimefunItemStack("FINALTECH_COMPOSTER", Material.CRAFTING_TABLE, TextUtil.colorPseudorandomString("高级搅拌机"));
    public static final SlimefunItemStack ADVANCED_JUICER = new SlimefunItemStack("FINALTECH_JUICER", Material.CRAFTING_TABLE, TextUtil.colorPseudorandomString("高级榨汁机"));
