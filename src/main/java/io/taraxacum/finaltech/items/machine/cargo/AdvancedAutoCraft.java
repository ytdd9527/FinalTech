package io.taraxacum.finaltech.items.machine.cargo;
...
public class AdvancedAutoCraft extends AbstractCargo implements RecipeItem {
    ...
    protected void tick(@Nonnull Block block, @Nonnull SlimefunItem slimefunItem, @Nonnull Config config) {
        ...
        AdvancedMachineRecipe machineRecipe = AdvancedAutoCraftLocationRegistry.getRecipe(location);
        ...
        InvWithSlots inputMap = CargoUtil.getInv(containerBlock, SlotSearchSize.INPUT_HELPER.getValue(config), SlotSearchOrder.VALUE_ASCENT);
        InvWithSlots outputMap = CargoUtil.getInv(containerBlock, SlotSearchSize.OUTPUT_HELPER.getValue(config), SlotSearchOrder.VALUE_ASCENT);
