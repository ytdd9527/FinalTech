...
import io.taraxacum.finaltech.items.machine.cargo.AbstractCargo;
import io.taraxacum.finaltech.menu.AbstractMachineMenu;
import io.taraxacum.finaltech.menu.machine.StorageInteractPortMenu;
            ...
            if (blockState instanceof InventoryHolder) {
                ...
                for (Map.Entry<ItemStack, ItemMeta> entry : map.entrySet()) {
                    ...
                    if (pushCount != 0 || stackCount != 0) {
                        StorageCardItem.updateStorageCardLore(itemMeta, stringItem.getItemStack());
                        entry.getKey().setItemMeta(itemMeta);
                        StorageCardItem.updateStorageCardType(entry.getKey(), itemMeta);
                    }
                }
            }
        }
